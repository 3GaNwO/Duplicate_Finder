...
class DuplicateFinderApp:
    ...
    def build_menu(self):
        ...
        file_menu.add_command(label="Undo Delete", command=self.undo_delete)
    ...
    def build_gui(self):
        ...
        undo_button = ttk.Button(btn_frame, text="Undo Delete", command=self.undo_delete)
        ...
        undo_move_btn = ttk.Button(btn_frame, text="Undo Move", command=self.undo_move)
        undo_move_btn.pack(side=tk.LEFT, padx=5)
...
def main():
    root = tk.Tk()
    root.iconbitmap('duplicate_finder.ico')
